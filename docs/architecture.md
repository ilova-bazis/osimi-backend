...
6) Worker posts progress/events to VPS
7) Worker uploads ingest.json as an object artifact
...
- ingest.json: permanent artifact stored under object artifacts on VPS
...
sequenceDiagram
  ...
  Worker->>VPS: Upload ingest.json artifact
