...
export const ingestionDocumentTypeSchema = z.enum([
  "newspaper_article",
  "magazine_article",
  "book_chapter",
  "book",
...
export const createIngestionBodySchema = z.strictObject({
  ...
  document_type: ingestionDocumentTypeSchema,
...
export const commitUploadedFileBodySchema = z.strictObject({
  file_id: z.uuid(),
  checksum_sha256: z.string().trim().min(1).regex(/^[a-f0-9]{64}$/i),
});
...
export type IngestionCursorPayload = z.infer<typeof ingestionCursorPayloadSchema>;
...
>;
export type CommitUploadedFileBody = z.infer<typeof commitUploadedFileBodySchema>;
export type UpdateIngestionFileOverridesBody = z.infer<
  typeof updateIngestionFileOverridesBodySchema
>;
export type AccessLevel = z.infer<typeof accessLevelSchema>;
export type IngestionDocumentType = z.infer<typeof ingestionDocumentTypeSchema>;
...
>;
export type DeleteIngestionResponse = z.infer<typeof deleteIngestionResponseSchema>;
export type SubmitIngestionResponse = z.infer<typeof submitIngestionResponseSchema>;
export type CancelIngestionResponse = z.infer<typeof cancelIngestionResponseSchema>;
export type RestoreIngestionResponse = z.infer<typeof restoreIngestionResponseSchema>;
export type RetryIngestionResponse = z.infer<typeof retryIngestionResponseSchema>;
